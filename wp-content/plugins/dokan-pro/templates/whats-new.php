...
$changelog = [
    [
        ...
        'changes'  => [
            'New' => [
                [
                    'title'       => 'Added sandbox mode and enhanced integration support in Dokan Stripe Express.',
                    'description' => '',
                ],
            ],
            'Improvement' => [
                [
                    'title'       => 'Simplified FreeShippingHandler class by removing unnecessary conditions and redundant code to improve maintainability and code clarity.',
                    'description' => '',
                ],
                [
                    'title'       => 'Subscription alert message styling for better visual alignment.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added auto synchronization between include and exclude product selectors in coupon admin to prevent product overlap during selection.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added required field indicators for required methods in Vendor Verification Setup Wizard.',
                    'description' => '',
                ],
                [
                    'title'       => 'Enhanced MangoPay gateway validation to handle "Pay for Order" scenarios with account eligibility checks.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added functionality to dismiss profile progress bar and store user preference for a day.',
                    'description' => '',
                ],
                [
                    'title'       => 'Enhanced Advertisement slot controls for Vendor Subscriptions.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Resolved an issue where the admin can not change the product meta tab in the product create edit screen when dokan booking module is activated.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved privilege escalation vulnerability in staff password reset by enforcing proper user identity validation.',
                    'description' => '',
                ],
                [
                    'title'       => 'Allow vendors to add unlimited products without an active subscription.',
                    'description' => '',
                ],
                [
                    'title'       => 'Fixed order fee line item display issues including column data alignment and currency symbol positioning in order edit page.',
                    'description' => '',
                ],
                [
                    'title'       => 'Coupon validation logic to require both vendor invalidity and product exclusion for a coupon to be marked invalid.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Improvement' => [
                [
                    'title'       => 'Enhanced vendor verification with a modern UI for a better user experience',
                    'description' => '',
                ],
                [
                    'title'       => 'Enhanced display of verification statuses, notes, documents, and seller address.',
                    'description' => '',
                ],
                [
                    'title'       => 'Added phone verification logic with OTP resend timers and input masking.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved social profile connection management with connect/disconnect actions.',
                    'description' => '',
                ],
                [
                    'title'       => 'Marked legacy product brand management features as deprecated in favor of WooCommerce native brands, with guidance for migration.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Improved refund handling by preventing automatic refunds when the seller is not connected to Stripe Express.',
                    'description' => '',
                ],
                [
                    'title'       => 'Fixed delivery time duplicate entry when place an order.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved the display of recurring payment intervals in subscription pricing, ensuring intervals are shown with the correct number and period type for greater clarity and localization.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved error messages for payment capture failures, ensuring clearer and more specific information is displayed to users when issues occur.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved the reliability and accuracy of subscription expiry alerts by enhancing date handling and error management.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved coupon tracking during vendor subscription checkout, ensuring that changes to applied coupons are detected and handled efficiently.',
                    'description' => '',
                ],
                [
                    'title'       => 'Resolved unable to purchase a new vendor subscription with trail by stripe express.',
                    'description' => '',
                ],
            ],
        ],
    ...
    [
        ...
        'changes'  => [
            'Improvement' => [
                [
                    'title'       => 'Enhanced social profile with a modern UI for a better user experience.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved UI of subscription pack listing on vendor dashboard.',
                    'description' => '',
                ],
            ],
            'Fix' => [
                [
                    'title'       => 'Resolved an issue where description and short-description contents were missing from the vendor dashboard subscription pack listing.',
                    'description' => '',
                ],
                [
                    'title'       => 'Fixed an issue where Line item & Item subtotal price shows 0 in recurring vendor subscription renewal order.',
                    'description' => '',
                ],
                [
                    'title'       => 'Fixed an issue where Multiple meta fields do not get saved when creating a product via dokan REST API.',
                    'description' => '',
                ],
                [
                    'title'       => 'Ensured item subtotals in PayPal Marketplace orders match the declared total, reducing the risk of calculation discrepancies.',
                    'description' => '',
                ],
                [
                    'title'       => 'Fixed date format inconsistency of store reviews in the single store page.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved error handling during subscription creation and updates, ensuring smoother recovery from errors and more reliable subscription management.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved handling of cost values for person types in bookings to ensure prices are stored and processed as numbers.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved handling of payment data to prevent errors when updating Stripe Express status for sellers.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved coupon validation to more accurately check vendor eligibility, ensuring coupons are only valid for the correct vendors and authors.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved handling of missing social profile fields, ensuring more accurate detection and display of incomplete profiles.',
                    'description' => '',
                ],
                [
                    'title'       => 'Shipping fee displaying correctly for multiple zone based shipping.',
                    'description' => '',
                ],
                [
                    'title'       => 'Corrected an issue where shipping tax was missing from vendor suborders when using Vendor Table Rate Shipping.',
                    'description' => '',
                ],
                [
                    'title'       => 'Improved display of vendor information to ensure an empty value is shown if vendor details are missing.',
                    'description' => '',
                ],
            ],
        ],
